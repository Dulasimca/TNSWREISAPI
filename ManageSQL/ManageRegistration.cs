            ...
            using (sqlConnection = new SqlConnection(GlobalVariable.ConnectionString))
            {
                ...
                try
                {
                   ...
                   // StudentParentInfoEntity parentInfoEntity = new StudentParentInfoEntity();
                    ...
                    sqlCommand.CommandType = CommandType.StoredProcedure;
                    sqlCommand.Parameters.AddWithValue("@StudentId", StudentId);
                    sqlCommand.Parameters.AddWithValue("@FatherTitle", studentEntity.fnTitleCode);
                    ...
                    sqlCommand.Parameters.AddWithValue("@MotherTitle", studentEntity.mnTitleCode);
                    ...
                    sqlCommand.Parameters.AddWithValue("@GuardianTitle", studentEntity.gnTitleCode);
