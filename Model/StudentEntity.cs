...
namespace TNSWREISAPI.Model
{
    public class StudentEntity
    {
        ...
        public string LastInstitutionAddress { get; set; }
        ...
        public string GuardianMoileNo { get; set; }
        public string GuardianName { get; set; }
        public string GuardianOccupation { get; set; }
        public string GuardianQualification { get; set; }
        public string TotalYearlyIncome { get; set; }
        ...
        public string HostelDName { get; set; }
        public string HostelTName { get; set; }
