...
namespace TNSWREISAPI.Model
{
    public class GeneratePDFDocument
    {
        ...
        public StudentEntity CheckValues(StudentEntity _studentEntity)
        {
            ...
            _studentEntity.StudentFilename = !string.IsNullOrEmpty(_studentEntity.StudentFilename) || _studentEntity.StudentFilename != "" ? _studentEntity.StudentFilename : "no_image.PNG";
            //};
